...
def _inicializar_sesion_usuario(request, id_usuario):
...
def _obtener_notificaciones_usuario():
    ...
    return list(materias_bajas), list(lotes_vencidos), list(lotes_por_vencer)
...
def roles_usuario(request):
    ...
    if id_usuario:
        ...
        _inicializar_sesion_usuario(request, id_usuario)
        materias_bajas, lotes_vencidos, lotes_por_vencer = _obtener_notificaciones_usuario()
