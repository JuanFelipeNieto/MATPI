...
def _descontar_stock_pedido(pedido):
    ...
    for detalle in pedido.detalles.all():
      ...
      # The above code is a Python comment section that explains the purpose and context of the code
      # that follows. It mentions the total quantity needed in the base unit of measurement (grams,
      # milliliters, etc) and provides some notes regarding how the quantity is handled in the code.
      # It also mentions that the quantity used is already in the base unit if it came from the
      # products/views, but if the user selected 'unit' in the product composition, it needs to be
      # multiplied. The comment section seems to be clarifying the logic and flow of the code for
      # anyone reading or working on it.
