...
class MateriaPrimaViewsCompleteTest(TestCase):
    ...
    def login_como_admin(self):
        """Método auxiliar para iniciar sesión como Administrador."""
    ...
    def login_como_cajero(self):
        """Método auxiliar para iniciar sesión como Cajero (no administrador)."""
        session = self.client.session
    ...
    def create_in_memory_excel(self, rows):
        """Genera un archivo .xlsx simulado en memoria para las pruebas de importación."""
    ...
    # ==========================================
    # 1. PRUEBA: Vista Principal (Listado de Materia Prima)
    # ==========================================
    def test_01_listar_materia_prima_get(self):
        """1. test_listar_materia_prima_get: Verifica que la lista principal de materias primas cargue correctamente."""
    ...
    # ==========================================
    # 2. PRUEBA: Listar Materia Prima (Búsqueda por filtro)
    # ==========================================
    def test_02_listar_materia_prima_buscar(self):
        """2. test_listar_materia_prima_buscar: Filtra materias primas utilizando el parámetro de búsqueda."""
        self.login_como_admin()
    ...
    # ==========================================
    # 3. PRUEBA: Mostrar Formulario de Registro (GET)
    # ==========================================
    def test_03_mostrar_registro_materia_prima_get(self):
        """3. test_mostrar_registro_materia_prima_get: Comprueba la carga de la vista del formulario de registro."""
        self.login_como_admin()
        response = self.client.get(reverse('mostrar_registro_materia_prima'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'materia_prima/registrar.html')

    # ==========================================
    # 4. PRUEBA: Registrar Materia Prima (POST Exitoso con Lote Inicial)
    # ==========================================
    def test_04_registrar_materia_prima_post_success(self):
        """4. test_registrar_materia_prima_post_success: Registra una nueva materia prima y su lote inicial mediante POST."""
        self.login_como_admin()
        datos = {
        ...
        # Comprobar que el lote inicial fue correctamente creado
        self.assertTrue(Lote.objects.filter(materia_prima=materia, cantidad_inicial=50).exists())

    # ==========================================
    # 5. PRUEBA: Registrar Materia Prima (POST Exitoso Sin Lote Inicial)
    # ==========================================
    def test_05_registrar_materia_prima_post_success_no_lote(self):
        """5. test_registrar_materia_prima_post_success_no_lote: Registra una materia prima con stock inicial en 0 sin crear lote."""
        self.login_como_admin()
        datos = {
            'txt_nombre': 'Lechuga Crespa',
            'txt_unidad': 'und',
        ...
        materia = MateriaPrima.objects.get(nombre_materia_prima='Lechuga Crespa')
        # No debe haberse creado ningún lote asociado
        self.assertEqual(materia.lotes.count(), 0)

    # ==========================================
    # 6. PRUEBA: Pre-Editar Materia Prima (GET)
    # ==========================================
    def test_06_pre_editar_materia_prima_get(self):
        """6. test_pre_editar_materia_prima_get: Carga el formulario de edición de la materia prima seleccionada."""
        self.login_como_admin()
    ...
    # ==========================================
    # 7. PRUEBA: Editar Materia Prima (POST Exitoso)
    # ==========================================
    def test_07_editar_materia_prima_post_success(self):
        """7. test_editar_materia_prima_post_success: Actualiza la información descriptiva de una materia prima."""
        self.login_como_admin()
        datos = {
    ...
    # ==========================================
    # 8. PRUEBA: Eliminar Materia Prima (Exitoso)
    # ==========================================
    def test_08_eliminar_materia_prima_success(self):
        """8. test_eliminar_materia_prima_success: Elimina una materia prima y recalcula el stock de los productos afectados."""
        self.login_como_admin()
        
        # Crear un producto asociado para comprobar el recálculo
    ...
    # ==========================================
    # 9. PRUEBA: Ver Lotes de Materia Prima
    # ==========================================
    def test_09_ver_lotes_get(self):
        """9. test_ver_lotes_get: Verifica la carga de la vista que lista todos los lotes activos y vencidos de un insumo."""
        self.login_como_admin()
    ...
    # ==========================================
    # 10. PRUEBA: Pre-Editar Lote (GET)
    # ==========================================
    def test_10_pre_editar_lote_get(self):
        """10. test_pre_editar_lote_get: Carga la plantilla de edición para un lote específico."""
        self.login_como_admin()
    ...
    # ==========================================
    # 11. PRUEBA: Editar Lote (POST Exitoso)
    # ==========================================
