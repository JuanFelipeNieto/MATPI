...
class ProductoViewsCompleteTest(TestCase):
    def setUp(self):
        ...
        self.lote_carne = Lote.objects.create(
            ...
            cantidad_inicial=10.0,  # 10 unidades de 150g = 1500g
    ...
    def login_como_cajero(self):
        """Método auxiliar para iniciar sesión como Cajero."""
        session = self.client.session
    ...
    def get_valid_png_image(self):
        """Genera un archivo simple PNG en bytes para validar la subida de imágenes."""
    ...
    # ==========================================
    # 1. PRUEBA: Vista Principal (Listado de Productos)
    # ==========================================
    def test_01_listar_productos_get(self):
        """1. test_listar_productos_get: Carga correctamente la lista del menú general de productos."""
