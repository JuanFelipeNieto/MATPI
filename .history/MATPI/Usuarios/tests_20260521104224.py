...
class UsuarioViewsCompleteTest(TestCase):
    ...
    def login_como_cajero(self):
        """Método auxiliar para iniciar sesión como Cajero en el cliente de pruebas."""
        session = self.client.session
    ...
    # ==========================================
    # 1. PRUEBA: Vista de Login (GET)
    # ==========================================
    def test_01_login_view_get(self):
        """1. test_login_view_get: Verifica el renderizado de la plantilla de inicio de sesión."""
        response = self.client.get(reverse('login'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'usuarios/login.html')

    # ==========================================
    # 2. PRUEBA: Vista de Login (POST Exitoso)
    # ==========================================
    def test_02_login_view_post_success(self):
        """2. test_login_view_post_success: Verifica el inicio de sesión correcto con credenciales válidas."""
        datos_login = {
            'txt_id': self.admin_user.id,
            'txt_contrasena': 'adminpass123'
        }
        response = self.client.post(reverse('login'), datos_login)
        # Debe redirigir al Dashboard tras iniciar sesión exitosamente
        self.assertRedirects(response, reverse('dashboard'))
        self.assertEqual(self.client.session['usuario_id'], self.admin_user.id)

    # ==========================================
    # 3. PRUEBA: Vista de Login (POST Fallido)
    # ==========================================
    def test_03_login_view_post_fail(self):
        """3. test_login_view_post_fail: Verifica que no se inicie sesión con credenciales incorrectas."""
        datos_login = {
            'txt_id': self.admin_user.id,
    ...
    # ==========================================
    # 4. PRUEBA: Vista de Logout
    # ==========================================
    def test_04_logout_view(self):
        """4. test_logout_view: Verifica el cierre de sesión y la limpieza de la sesión."""
        self.login_como_admin()
        response = self.client.get(reverse('logout'))
        # Debe redirigir al Login tras cerrar sesión
    ...
    def test_05_dashboard_view(self):
        """5. test_dashboard_view: Verifica que el dashboard cargue correctamente para un usuario logueado."""
        self.login_como_admin()
    ...
    # ==========================================
    # 6. PRUEBA: Listar Usuarios
    # ==========================================
    def test_06_listar_usuarios_view(self):
        """6. test_listar_usuarios_view: Verifica el listado de colaboradores cajeros para el administrador."""
        self.login_como_admin()
    ...
    def test_07_ver_perfil_view(self):
        """7. test_ver_perfil_view: Verifica que se muestre correctamente el perfil del usuario consultado."""
        self.login_como_admin()
    ...
    # ==========================================
    # 8. PRUEBA: Registrar Usuario (GET)
    # ==========================================
    def test_08_registrar_usuario_get(self):
        """8. test_registrar_usuario_get: Verifica el acceso al formulario de registro de colaboradores."""
        self.login_como_admin()
    ...
    # ==========================================
    # 9. PRUEBA: Registrar Usuario (POST Exitoso)
    # ==========================================
    def test_09_registrar_usuario_post_success(self):
        """9. test_registrar_usuario_post_success: Verifica la creación de un nuevo Cajero con datos válidos."""
        self.login_como_admin()
        datos_registro = {
            'txt_id': '1122334455',
    ...
    # ==========================================
    # 10. PRUEBA: Registrar Usuario (POST Fallido - Validación)
    # ==========================================
    def test_10_registrar_usuario_post_fail_validation(self):
        """10. test_registrar_usuario_post_fail_validation: Verifica el rechazo al intentar registrar con documento inválido."""
        self.login_como_admin()
        datos_incorrectos = {
    ...
    # ==========================================
    # 11. PRUEBA: Editar Usuario (GET)
    # ==========================================
    def test_11_editar_usuario_get(self):
        """11. test_editar_usuario_get: Verifica la carga del formulario de edición con los datos del usuario."""
        self.login_como_admin()
    ...
    # ==========================================
    # 12. PRUEBA: Editar Usuario (POST Exitoso)
    # ==========================================
    ...
    # ==========================================
    # 13. PRUEBA: Eliminar Usuario (Exitoso)
    # ==========================================
