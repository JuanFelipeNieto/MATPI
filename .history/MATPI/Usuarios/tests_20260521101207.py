...
class AutenticacionTests(TestCase):
    """Pruebas unitarias para el Login y Logout de usuarios."""
...
class GestionUsuariosTests(TestCase):
    ...
    def test_registrar_usuario_exitoso(self):
        # Comentario: Verifica que el Administrador pueda registrar un nuevo cajero con datos completos y válidos.
        self.login_como(self.admin)
