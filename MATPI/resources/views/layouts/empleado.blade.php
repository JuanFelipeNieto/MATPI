...
<body class="@yield('body-class')">
    ...
    <header class="header">
        ...
        <nav class="top-nav">
            <a href="{{ route('empleado.dashboard') }}" class="nav-link active">🏠 Dashboard</a>
        ...
        <div class="profile-dropdown">
            <button class="profile-btn">👤 {{ Auth::user()->Nombre_Corto }}</button>
            <div class="dropdown-content">
                <a href="{{ route('empleado.perfil') }}">Información de perfil</a>
                <a href="{{ route('logout') }}"
